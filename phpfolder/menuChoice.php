...
if ($storeName !="" ){ 
    ...
    $sql="SELECT size, hotIce FROM causk.menu join causk.store on menu.storeSerial=store.storeSerial where storeName='$storeName' and category='$category' and menuName='$menuName';";
