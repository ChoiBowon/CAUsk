...
if ($storeName !="" ){ 
    ...
    $sql="SELECT distinct(CASE WHEN hotIce=1 THEN 'ice' WHEN hotIce=0 THEN 'hot' END) as 'hotIce' FROM causk.menu join causk.store on menu.storeSerial=store.storeSerial where storeName='$storeName' and category='$category' and menuName='$menuName';";
