...
if ($storeName !="" ){ 
    ...
    $sql="SELECT price FROM causk.menu join causk.store on menu.storeSerial=store.storeSerial where storeName='$storeName' and category='$category' and menuName='$menuName' and size='$size' and hotIce='$hotIce2'";
...
<html>
   <body>
      ...
      <form action="<?php $_PHP_SELF ?>" method="POST">
         ...
         핫/아이스: <input type = "text" name = "hotIce" />
         <input type = "submit" />
      </form>
