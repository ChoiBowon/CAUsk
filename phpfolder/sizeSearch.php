...
if ($storeName !="" ){ 
    ...
    $sql="SELECT distinct size FROM causk.menu join causk.store on menu.storeSerial=store.storeSerial where storeName='$storeName' and category='$category' and menuName='$menuName';";
