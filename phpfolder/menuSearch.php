...
if ($storeName !="" ){ 
    $sql="SELECT distinct menuName FROM causk.menu join causk.store on menu.storeSerial=store.storeSerial where storeName='$storeName' and category='$category';";
    ...
    if($result){  
        ...
        if ( 0 == $row_count ){
            ...
            array_push($data,
                array( 'storeName'=>$storeName, 'category'=>$category)
            );
