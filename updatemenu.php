...
echo($HotIce);
 ...
 $sql="UPDATE menu SET storeSerial='".$_SESSION['storeSerial']."', category='".$_POST['Category']."',menuName='".$_POST['MenuName']."',size='".$_POST['Size']."',hotIce,price) VALUES('".$_SESSION['storeSerial']."','".$_POST['category_selbox']."','".$_POST['MenuName']."','".$_POST['size_selbox']."','$HotIce','".$_POST['Price']."')";
